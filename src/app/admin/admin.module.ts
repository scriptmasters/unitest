...
import { TestService } from './subjects/tests/test.service';
...
import { EditComponent } from './subjects/tests/edit/edit.component';
import { AddComponent } from './subjects/tests/add/add.component';
